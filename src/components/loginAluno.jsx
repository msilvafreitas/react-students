...
export function LoginAluno() {
    ...
    const LOGIN_URL = '/aluno/student/login';
        ...
        <div className="flex justify-center items-center py-40  px-6">
            <div className="p-6 max-w-sm w-full bg-gray-head shadow-md rounded-md">
                <div className="flex justify-center items-center">
                    <span className="text-black-text font-semibold text-2xl">Login - Aluno</span>
                </div>
                ...
                <form className="mt-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-around mt-4">
                        <button onClick={() => {navigate('/')}}  className="block text-sm fontme text-blue-button hover:underline" href="#">Entre como Professor</button>
                    </div>
                </form>
            </div>
        </div>
